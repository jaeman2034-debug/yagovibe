...
exports.weeklyAutoReport = void 0;
 ...
 * - Slack 알림 발송
 */
exports.weeklyAutoReport = functions.scheduler.onSchedule({
    ...
    try {
        ...
        const logs = logsSnap.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
        ...
        // 4️⃣ OpenAI 요약 생성
        const logsText = logs.slice(0, 50).map(log => `- ${log.text || ""} (${log.intent || "미확인"})`).join("\n");
...
한국어로 3-5문장으로 작성하세요.`;
        ...
        const summary = ((_c = (_b = completion.choices[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content) || "요약 생성 실패";
        ...
        // 9️⃣ Slack 알림 발송
        const slackWebhook = ((_d = functions.config().slack) === null || _d === void 0 ? void 0 : _d.webhook) || process.env.VITE_SLACK_WEBHOOK_URL;
        if (slackWebhook) {
        ...
        // 에러 발생 시 Slack 알림
        const slackWebhook = ((_e = functions.config().slack) === null || _e === void 0 ? void 0 : _e.webhook) || process.env.VITE_SLACK_WEBHOOK_URL;
        if (slackWebhook) {
            try {
                await fetch(slackWebhook, {
                    method: "POST",
...
//# sourceMappingURL=weeklyAutoReport.js.map