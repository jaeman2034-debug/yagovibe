/**
 * PR4 Sprint B prep — AlimTalk templates (Functions copy; keep in sync with
 * src/lib/notifications/alimtalkTemplates.ts).
 */
...
export function resolveAlimTalkTemplateCode(id: AlimTalkTemplateId): string | null {
  const key = ALIMTALK_TEMPLATE_REGISTRY[id].templateCodeEnvKey;
