...
const EXPERIMENT_ID = "high_risk_day0_v1";
...
export const evaluateHighRiskDay0Experiment = onSchedule(
  {
    schedule: "0 1 * * *",
    timeZone: "Asia/Seoul",
  ...
  async () => {
    ...
    logger.info("[evaluateHighRiskDay0Experiment] evaluated", {
      aSent,
      bSent,
      aRate,
      bRate,
