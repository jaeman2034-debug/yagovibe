 ...
 * 
 * 사용법:
 * node scripts/fix-market-author-id.js <새로운UID>
 * 
 * 예시:
 * node scripts/fix-market-author-id.js iUZB8RjKlEhb3uotZ6yqtpWtUQE2
 * 
...
const serviceAccountPath = 
  require("fs").existsSync(path.join(__dirname, "..", "functions", "serviceAccountKey.json"))
...
if (!newUid) {
  console.error("❌ 사용법: node scripts/fix-market-author-id.js <새로운UID>");
  console.error("예시: node scripts/fix-market-author-id.js iUZB8RjKlEhb3uotZ6yqtpWtUQE2");
  process.exit(1);
}
