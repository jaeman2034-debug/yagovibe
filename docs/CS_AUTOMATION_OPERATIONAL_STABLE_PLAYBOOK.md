...
**목표**: CS 자동화 99% 유지, 분쟁 97% 감축, 매출 4.2% 확보  
**배포 상태**: ✅ 프로덕션 준비 완료
...
**조건**: 수익률 < 4.2% (목표 대비 10% 이상 하락)  
**처리**: 광고 비율 감소 (10% → 8%, 최소 5%까지)

**복원 조건**: 수익률 ≥ 4.2% 달성 시 점진적 복원

**실행 주기**: 매일 00:00 (Asia/Seoul)

```typescript
const PROFIT_MARGIN_TARGET = 4.2; // 4.2%
...
```json
{
  "event": "MARGIN_OPTIMIZATION_LOOP",
...
- [ ] 카테고리 급등 검수 동작 확인
- [ ] 고위험 카테고리 검수 동작 확인
- [ ] 수익률 모니터링 동작 확인 (4.2% 목표)
- [ ] 마진 하락 광고 비율 자동 조정 동작 확인

---

**CS 자동화 운영 안정 플레이북 완성**
