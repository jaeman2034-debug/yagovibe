# 🔥 PR 5 완료: 기존 "대회 참가 준비" UI 제거 & Opportunity 카드로 흡수
...
### PersonaP0NewUser (P0 신규 유저)
PersonaP0NewUser의 "팀 참여" 버튼은 유지됩니다. 이는 P0 (신규 유저)가 Persona를 선택하는 단계이므로 정상적인 UX입니다.
