...
**파일**: `src/pages/LoginPage.tsx` (326-352줄)
...
**파일**: `src/lib/firebase.ts` (216-222줄)
...
// VITE_GOOGLE_CLIENT_ID 환경변수도 더 이상 필요 없음
```
...
## ✅ 3) firebaseConfig.authDomain 확인

**파일**: `src/lib/firebase.ts` (59-67줄)
