// src/pages/archive/RegionArchivePage.tsx
// 🔥 지역 아카이브 페이지 (읽기 전용 기록 집계)
...
export default function RegionArchivePage() {
  ...
  useEffect(() => {
    ...
    const fetchArchive = async () => {
      try {
        ...
        // SEO 메타 태그
        const seoTitle = `${region} 지역 팀 활동 기록 | 기록장`;
        const seoDescription = `${region} 지역에서 이어지고 있는 팀 활동을 기록으로 정리했습니다.`;
        ...
        updateMetaTag("og:url", `${window.location.origin}/archive/region/${region}`, true);
