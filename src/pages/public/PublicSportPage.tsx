// src/pages/public/PublicSportPage.tsx
// 🔥 공공용 종목 페이지 (읽기 전용 · 외부 안전)
...
export default function PublicSportPage() {
  ...
  useEffect(() => {
    ...
    const fetchPublicRecords = async () => {
      try {
        ...
        // SEO 메타 태그 (중립)
        const seoTitle = `${sport} 팀 활동 기록`;
        const seoDescription = `${sport} 팀들의 활동을 날짜가 남는 기록으로 정리했습니다.`;
        ...
        updateMetaTag("og:url", `${window.location.origin}/public/sport/${sport}`, true);
