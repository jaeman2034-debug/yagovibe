...
import { Users, GraduationCap, Building2, Trophy, ChevronRight } from "lucide-react";

export interface DefaultFabCreateContentProps {
  onClose: () => void;
}
...
const DEFAULT_OPTIONS = [
  ...
  },
  {
    id: "match",
    label: "경기 매칭",
    description: "새 매칭 글을 작성합니다",
    icon: Trophy,
    path: "/sports/soccer/match/create",
  },
] as const;

export function DefaultFabCreateContent({ onClose }: DefaultFabCreateContentProps) {
