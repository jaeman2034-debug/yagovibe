...
| **Known Issue** | `BETA-ISSUE-001` ⚠️ OPEN · **P1** |
...
2. Known Issue(`BETA-ISSUE-001`)를 **OPEN + P1**로 관리하며 운영 중 개선한다.
...
|---|---|---|---|---|
| **BETA-ISSUE-001** | **P1** | ⚠️ **OPEN** | `parent_login_friction` | iPhone + 카카오 인앱 · `/login` 재요구 · Android 미재현 (Beta Official Fact) |
...
- 해결 완료로 단정하지 않는다. **OPEN** 유지 또는 Fix Verification 후 상태 변경.
- 재현 시 Official Fact만 Incident/KPI에 기록한다.
- Fix 검증 기준: `PAI_001_FIX_VERIFICATION.md` (PASS/FAIL)
- Fix 후 Parent 독립 사용 Gate 재검증을 수행한다 (`PAI-003`).
...
**Updated:** 2026-07-21  
**Decision:** GO with Open Issue · `BETA-ISSUE-001` OPEN (P1)
