...
|---|---|---|---|---|
| **BETA-ISSUE-001** | **P1** | ✅ **CLOSED (Verified)** | `parent_login_friction` | PAI-001 PASS · Prod-W01 Day-01 재발 **N** · 모니터링=PAI-002 ACTIVE · 일반화 금지 |
...
**Updated:** 2026-07-13 · Prod-W01 Day-01 ACCEPT/LOCK · ISSUE-001 **CLOSED (Verified)** 정렬  
