...
| ID | Item | Status | Owner | Note |
|---|---|---|---|---|
| **PAI-011** | VOC-011 — 또래(팀·연령) 평균 기준선 | 🔒 **COMPLETE / CLOSED** | PM · Eng | Post-Deploy Smoke **PASS** · HEAD `64270a3` · feature `07fb689` · `PAI_011_POST_DEPLOY_SMOKE.md` · VOC-011 **15 LOCKED** · Day-03 ACCEPT/LOCK (15→16 NO-GO) |
...
| **PAI-022** | Weekly Production Review 루틴 시작 | ▶ PLANNED | PM · Ops | `PRODUCTION_WEEKLY_REVIEW.md` · Week=Mon–Sun KST · Prod-W01=2026-07-13~19 · Review=주간 종료 후 별도 PM GO · Launch Partial≠W01 |
...
**Updated:** 2026-07-12 · PAI-022 pre-start docs alignment · Week rule LOCK · PLANNED 유지 · Day-03 LOCK · VOC-011 **15** · PAI-031 CLOSED 유지
