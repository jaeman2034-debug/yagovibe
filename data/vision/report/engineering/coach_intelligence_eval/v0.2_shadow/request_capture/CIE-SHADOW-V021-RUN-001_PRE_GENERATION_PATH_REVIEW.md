...
- **A_cip_v021_actually_loaded:** False
- **B_prompt_sha_differs_from_v020:** True
- **C_sample_context_materially_different:** True
- **D_pass_count_first_or_emphasized_identically:** False
- **E_hidden_hardcoded_pass_opening_in_runner:** False
- **F_candidate_or_prior_generation_reused:** False
- **G_promptVersion_metadata_matches_content:** False
- **H_user_serializer_fixed_evidence_order:** True
- **I_distinctive_evidence_present_per_sample:** {'CIE-SHADOW-V02-002': {'axisPresent': True, 'playerAliasesPresent': True, 'sequenceEventCountsPresent': True, 'coachInsightFocusPresent': True, 'multiPlayerDistinct': False, 'adversarialBaitPresent': False}, 'CIE-SHADOW-V02-001': {'axisPresent': True, 'playerAliasesPresent': True, 'sequenceEventCountsPresent': True, 'coachInsightFocusPresent': True, 'multiPlayerDistinct': False, 'adversarialBaitPresent': False}, 'CIE-SHADOW-V02-003': {'axisPresent': True, 'playerAliasesPresent': True, 'sequenceEventCountsPresent': True, 'coachInsightFocusPresent': True, 'multiPlayerDistinct': False, 'adversarialBaitPresent': False}, 'CIE-SHADOW-V02-016': {'axisPresent': True, 'playerAliasesPresent': True, 'sequenceEventCountsPresent': True, 'coachInsightFocusPresent': True, 'multiPlayerDistinct': False, 'adversarialBaitPresent': False}}
